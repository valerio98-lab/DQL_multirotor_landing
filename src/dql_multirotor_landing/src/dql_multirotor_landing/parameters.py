...
class UAVParameters:
    def __init__(self):
        ...
        self.action_max_values: dict = {
            "pitch": np.deg2rad(21.37723),  # rad
        }
        # Action increments
        self.action_delta_values: dict = {
            "pitch": np.deg2rad(7.12574),  # rad
        }
...
class RLParameters:
    def __init__(self):
        ...
        self.scale_modification_value: dict = {
            "Q_table": [
                0.8172650252856599,
                0.8211253690681617,
                0.8257273369742982,
...
class SimulationParameters(UAVParameters):
    def __init__(self):
        ...
        self.init_max_x: np.ndarray = np.array([0, 4.5])
        self.init_min_x: np.ndarray = np.array([-4.5, 0])
        self.init_max_y: np.ndarray = np.array([0, 0])
        self.init_min_y: np.ndarray = np.array([0, 0])
        self.init_max_z: np.ndarray = np.array([0, 0])
        self.init_min_z: np.ndarray = np.array([0, 0])
