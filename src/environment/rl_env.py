...
from omni.isaac.lab.managers import ActionTermCfg as ActTerm
...
class ActionsCfg:
    ...
    joint_target = mdp.JointVelocityActionCfg(
        asset_name="target",
    ...
    # joint_agent = mdp.JointVelocityActionCfg(
    #     asset_name="agent",
    #     joint_names=[".*"],
    #     scale=0.5,
    # )
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        joint_vel = ObsTerm(
            ...
            params={"asset_cfg": SceneEntityCfg(name="agent", joint_names=[".*"])},
        )
...
def main():
    ...
    while simulation_app.is_running():
        with torch.inference_mode():
            ...
            joint_efforts = torch.tensor([100.0, 0.0, 3.0, 0.0, 0.0, 0.0], device=env.device).unsqueeze(0)
